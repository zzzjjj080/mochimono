...
- [x] 著作権 `2026 Niu Works`、リリース方法は **`AFTER_APPROVAL`（自動）**
...
- [x] **全部そろったら「全部外す」を緑にして確認なしのワンタップ**。6秒の「元に戻す」つき（2026-09-16 本人の依頼）
...
# 3. バージョンの枠を作る
./Tools-ASC.py post /v1/appStoreVersions '{"data":{"type":"appStoreVersions","attributes":{"platform":"IOS","versionString":"1.1","releaseType":"AFTER_APPROVAL","copyright":"2026 Niu Works"},"relationships":{"app":{"data":{"type":"apps","id":"6806789668"}}}}}'
